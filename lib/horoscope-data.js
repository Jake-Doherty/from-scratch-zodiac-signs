const horoscopes = [
  ...
  },
  {
    ...
    name: 'libra',
    horoscope:
      'You are known to be one the more indecisive and people-pleasing members of the zodiac, sweet Libra, and with the Aquarius moon forming a harsh t-square with the nodes of fate this morning, these sentiments will become amplified. Fear of change or the unknown could cause you to hold back right now, though it will be worth your while to proceed down your path with caution. A rocky and destructive vibe could manifest later in the afternoon when Luna squares off with Uranus, so you will want to be extra mindful of your words and how you carry yourself.',
  },
  {
    id: '8',
    name: 'pisces',
